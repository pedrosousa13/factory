// Pure migration-planning module (PRD #39 §6 "Steps"; PROTOCOL.md:639-689
...
// doc).
//
// Idempotency is what makes migration safe to interrupt (PROTOCOL.md:656-664):
...
/** One entry in the migration chain (PROTOCOL.md:651-654): v1 to v2, and —
 ...
 * the plugin's version gets none back — ahead is the block PROTOCOL.md:688-689
...
// PROTOCOL.md:671-672: detected from the H1 only, case-insensitively — never
...
/**
 * What the v1-to-v2 step needs to ask (PROTOCOL.md:669-676): the tracker is
...
/**
 * One combined plan for every pending step (PROTOCOL.md:651-654): a single
...
/**
 * The v1-to-v2 step's config.json content (PROTOCOL.md:675-676): exactly the
