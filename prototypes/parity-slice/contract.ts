// Copied verbatim from prototype/tracker-contract for the parity slice.
// Divergences from the runtime prototype's Effect union are reconciled after this slice reports.
